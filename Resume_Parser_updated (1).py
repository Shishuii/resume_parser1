...
def main():
   ...
   txt_file = open('email_reply_new1.txt','a')
   ...
   con1 = open('content_sample_1.txt','r')
   con1_txt = con1.read()   
   con2= open('content_sample_2.txt','r')
   con2_txt = con2.read()
   ...
   for f in files:
       ...
       txt_file.write('\n'+email +'\n')
       txt_file.write( skill + '\n')
       txt_file.write(' Hi %s, \n '%name)
       if ("c programming" or "c++ programming")  in s1:
           txt_file.write(con1_txt)
       elif ("php" or "mysql") in s1:
           txt_file.write(con2_txt)
